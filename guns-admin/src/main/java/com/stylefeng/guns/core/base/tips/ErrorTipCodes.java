...
public enum ErrorTipCodes {
    ...
    SYS_UNKNOWN_BIZ_CHANNEL           ("0024", "SYS_UNKNOWN_BIZ_CHANNEL"        , "未知券码类型/支付方式"   ),
    ...
    SYS_CHANNEL_WITHOUT_BIZ_TYPE      ("0031", "SYS_CHANNEL_WITHOUT_BIZ_TYPE"   , "渠道未开放的交易类型"    ),
    SYS_UNKNOWN_ORDER_TYPE            ("0032", "SYS_UNKNOWN_ORDER_TYPE"         , "未知交易状态"           ),
    SYS_UNKNOWN_REFUND_TYPE           ("0033", "SYS_UNKNOWN_REFUND_TYPE"        , "未知的退款类型"          ),
    SYS_UNKNOWN_ORDER_TRPE            ("0034", "SYS_UNKNOWN_ORDER_TRPE"         , "未知的订单类型"         ),
    SYS_ORDER_NO_UPDATE_ERROR         ("0035", "SYS_ORDER_NO_UPDATE_ERROR"      , "订单号更新出错"         ),
    SYS_DATABASE_INSERT_ERROR         ("0036", "SYS_DATABASE_INSERT_ERROR"      , "数据库插入异常"         ),
    SYS_DATABASE_DELETE_ERROR         ("0037", "SYS_DATABASE_DELETE_ERROR"      , "数据库删除异常"         ),
    SYS_DATABASE_UPDATE_ERROR         ("0038", "SYS_DATABASE_UPDATE_ERROR"      , "数据库更新异常"         ),
    SYS_DATABASE_SELECT_ERROR         ("0039", "SYS_DATABASE_SELECT_ERROR"      , "数据库查询异常"         ),
    ;
    ...
    ErrorTipCodes(String code, String stat, String message) {
        this.code = code;
        this.stat = stat;

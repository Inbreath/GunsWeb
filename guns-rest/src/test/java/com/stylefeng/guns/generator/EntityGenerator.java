...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("G:\\WorkPlaceGunsLearning\\guns-rest\\src\\main\\java");//这里写你自己的java目录
        ...
        dsc.setPassword("upay_mysql");
        dsc.setUrl("jdbc:mysql://192.168.253.118:3306/rest?characterEncoding=utf8");
        ...
        strategy.setInclude(new String[]{"tbl_house"});
